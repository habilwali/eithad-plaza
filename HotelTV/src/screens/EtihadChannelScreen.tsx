/**
 * Etihad TV Channels — separate page with same UI/UX as TV Channels.
 * Kept independent so Etihad-specific API can be swapped in later.
 */
...
export default function EtihadChannelScreen({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // TODO: switch these calls to dedicated Etihad TV API endpoints.
